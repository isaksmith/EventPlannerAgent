...
function BrandSource({ kit }: { kit: BrandKit }) {
  const source =
    kit.generatedBy === 'loading'
      ? 'Generating…'
      : kit.generatedBy === 'openrouter' || kit.generatedBy === 'midjourney'
        ? 'OpenRouter'
        : 'Generated assets'
  ...
  if (k === 'branding') {
    ...
    if (!full) return (
      <div className="p-3 space-y-3 h-full flex flex-col">
        ...
        <div className="rounded-lg border border-line scanline overflow-hidden flex-1 min-h-[48px]">
          {kit.heroImageUrl ? (
      ...
      <div className="p-3 h-full flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <a
            ...
            className="text-[10px] px-2.5 py-1 rounded-md text-surface font-medium hover:brightness-110"
